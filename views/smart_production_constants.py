...
NODE_SCHEMAS = {
    "serial": [
        ...
        {"key": "output_property", "label": "输出属性", "type": "select", "dynamic_source": "device_action", "options": [], "default": ""},
    ],
    "message": [
    ...
    "screw_conveyor": [
        {"key": "device_name", "label": "选择设备", "type": "select", "dynamic_source": "device_instance", "options": [], "default": ""},
        {"key": "action", "label": "执行动作", "type": "select", "dynamic_source": "device_action", "options": [], "default": ""},
        {"key": "output_property", "label": "输出属性", "type": "select", "dynamic_source": "device_action", "options": [], "default": ""},
    ],
    "belt_conveyor": [
        {"key": "device_name", "label": "选择设备", "type": "select", "dynamic_source": "device_instance", "options": [], "default": ""},
